...
relations4 =["<",">","bằng","="]
agents = ["Lan", "Minh", "An", "Bình", "Hoa", "Nam", "Hà", "Tuấn","hải","bách","hồng","ánh"]
...
attributes = ["táo", "cam", "chuối", "nho", "dưa", "laptop", "sách", "bút", "vở", "bánh", "sữa", "cơm", "phở",
              "kẹo", "gà", "vịt", "heo", "bò", "cá", "quần", "áo", "giày", "mũ","dứa","dưa hấu","ổi","xoài","sắt","đồng","nhôm","thép"]
...
def generate_sample():
    ...
    return [base, sample, sample2, sample3, sample4, sample5, sample6, sample7, sample8, sample9]

# Sinh nhiều mẫu và lưu file .conll
with open("synthetic_data.conll", "w", encoding="utf-8") as f:
    for _ in range(20):  # số mẫu cần sinh
